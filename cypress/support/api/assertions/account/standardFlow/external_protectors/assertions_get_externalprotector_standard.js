...
class AssertionsGetExternalProtectorStandard extends AssertionsBaseExtended {
    ...
    verifyExternalProtectorsIsOrdered(response) {
        /*
    ...
    verifyExternalProtectorsIsFiltered(response) {
        /*
              Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetExternalProtectorStandard = new AssertionsGetExternalProtectorStandard();