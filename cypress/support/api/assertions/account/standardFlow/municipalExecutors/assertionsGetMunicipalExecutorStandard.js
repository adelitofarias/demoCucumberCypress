...
class AssertionsGetMunicipalExecutorStandard extends AssertionsBaseExtended {
    ...
    verifyMunicipalExecutorsIsOrdered(response) {
        /*
    ...
    verifyMunicipalExecutorsIsFiltered(response) {
        /*
          Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetMunicipalExecutorStandard = new AssertionsGetMunicipalExecutorStandard();