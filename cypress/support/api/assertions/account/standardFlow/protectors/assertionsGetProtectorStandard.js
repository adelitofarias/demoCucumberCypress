...
class AssertionsGetProtectorStandard extends AssertionsBaseExtended {
    ...
    verifyProtectorsIsOrdered(response) {
        /*
    ...
    verifyProtectorsIsFiltered(response) {
        /*
              Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetProtectorStandard = new AssertionsGetProtectorStandard();