...
class AssertionsGetAdminsStandard extends AssertionsBaseExtended {
    ...
    verifyAdminsIsOrdered(response) {
        /*
    ...
    verifyAdminsIsFiltered(response) {
        /*
          Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetAdminsStandard = new AssertionsGetAdminsStandard();