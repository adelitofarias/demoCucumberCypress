...
class AssertionsGetMunicipalManagerStandard extends AssertionsBaseExtended {
    ...
    verifyMunicipalManagersIsOrdered(response) {
        /*
    ...
    verifyMunicipalManagersIsFiltered(response) {
        /*
          Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetMunicipalManagerStandard = new AssertionsGetMunicipalManagerStandard();