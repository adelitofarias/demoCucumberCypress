...
class AssertionsPatchStateRegulatorStandard extends AssertionsBaseExtended {
    verifyStateRegulatorUpdate(reguladorUpdate, response) {
...
export const assertionsPatchStateRegulatorStandard = new AssertionsPatchStateRegulatorStandard();