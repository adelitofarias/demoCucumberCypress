...
class AssertionsGetStateRegulatorStandard extends AssertionsBaseExtended {
    ...
    verifyStateRegulatorsIsOrdered(response) {
        /*
    ...
    verifyStateRegulatorsIsFiltered(response) {
        /*
          Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetStateRegulatorStandard = new AssertionsGetStateRegulatorStandard();