...
class AssertionsGetClinicManagerStandard extends AssertionsBaseExtended {
    ...
    verifyClinicManagersIsOrdered(response) {
        /*
    ...
    verifyClinicManagersIsFiltered(response) {
        /*
          Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetClinicManagerStandard = new AssertionsGetClinicManagerStandard();