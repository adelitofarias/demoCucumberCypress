...
class AssertionsGetMunicipalRegulatorStandard extends AssertionsBaseExtended {
    ...
    verifyMunicipalRegulatorsIsOrdered(response) {
        /*
    ...
    verifyMunicipalRegulatorsIsFiltered(response) {
        /*
          Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetMunicipalRegulatorStandard = new AssertionsGetMunicipalRegulatorStandard();