...
class AssertionsGetExecutionlocalsStandard extends AssertionsBaseExtended {
    ...
    verifyExecutionLocalsIsOrdered(response) {
        /*
    ...
    verifyExecutionLocalsIsFiltered(response) {
        /*
          Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetExecutionlocalsStandard = new AssertionsGetExecutionlocalsStandard();