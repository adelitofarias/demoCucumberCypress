...
class AssertionsGetExecutionEntitiesStandard extends AssertionsBaseExtended {
    ...
    verifyExecutionEntitiesIsOrdered(response) {
        /*
    ...
    verifyExecutionEntitiesIsFiltered(response) {
        /*
          Estratégia: iterar por cada objeto da lista verificando
...
export const assertionsGetExecutionEntitiesStandard = new AssertionsGetExecutionEntitiesStandard();